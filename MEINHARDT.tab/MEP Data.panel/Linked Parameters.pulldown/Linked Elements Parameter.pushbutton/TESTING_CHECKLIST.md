# Linked Elements Parameter Transfer - Testing Checklist
...
## Linked Source Element Selection
1. Select a link in dropdown.
2. Click Detect Linked Elements or Pick Linked Element(s).
3. Pick a linked source element from selected link:
   - Expect source info panel updates (category/identity/level/link).
   - Expect source parameter list populates.
4. Pick a linked element that is not the selected source category:
